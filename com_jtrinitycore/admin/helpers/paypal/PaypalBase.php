...
require_once( JPATH_COMPONENT_ADMINISTRATOR.DS.'helpers/paypal'.DS.'HTTPRequest.php' );
require_once( JPATH_COMPONENT_ADMINISTRATOR.DS.'helpers/paypal'.DS.'PaypalGateway.php' );
...
class PaypalBase {
    ...
    protected function response($data){
        $request = new HTTPRequest2($this->gateway->getHost(), $this->endpoint, 'POST', true);
