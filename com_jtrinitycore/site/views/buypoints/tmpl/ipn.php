...
try {
	...
	JLog::add("Error IPN. UserId=".$user->id. "  Username=".$user->username."   Remote IP=".JTrinityCoreUtilities::getRemoteIP()."  Message=".$e->getMessage(),JLog::CRITICAL,'ipn.php');
...
*/
    ...
    JLog::add("Verified IPN. UserId=".$user->id. "  Username=".$user->username."   Remote IP=".JTrinityCoreUtilities::getRemoteIP()."  Report=".$listener->getTextReport(),JLog::INFO,'ipn.php');
...
*/
    ...
    JLog::add("Invalid IPN. UserId=".$user->id. "  Username=".$user->username."   Remote IP=".JTrinityCoreUtilities::getRemoteIP()."  Report=".$listener->getTextReport(),JLog::CRITICAL,'ipn.php');
}
