...
function PPHttpPost($methodName_, $nvpStr_) {
	...
	$API_UserName = urlencode('fmeneu_1329943723_biz_api1.gmail.com');
	$API_Password = urlencode('1329943746');
	$API_Signature = urlencode('A2CkqI2QsZXhyU6jcInpYRcSqq0cAFcNFOqky5XrkX5rVVVitZe.ukXS');
